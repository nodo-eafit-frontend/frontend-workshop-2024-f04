...
export const getChoicesMessage = (playerChoice, computerChoice) => {
	const choicesPlayers = `
		The player choice: ${playerChoice.text}, ${playerChoice.emoji}, ${playerChoice.value} \n
		The computer choice: ${computerChoice.text}, ${computerChoice.emoji}, ${computerChoice.value}
	`
	return choicesPlayers;
};
 ...
 */
export const getScoreMessage = (stats) => `Lifes:${stats.lifes}💞 ,Score: ${stats.score}🪙`;
