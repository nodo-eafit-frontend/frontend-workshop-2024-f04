...
const playGame = async () => {
	...
	const response = await prompts({
		...
		choices: [
			{ title: `${CHOICES.rock.text} ${CHOICES.rock.emoji}`, value: CHOICES.rock.value },
			{ title: `${CHOICES.paper.text} ${CHOICES.paper.emoji}`, value: CHOICES.paper.value },
			{ title: `${CHOICES.scissors.text} ${CHOICES.scissors.emoji}`, value: CHOICES.scissors.value },
		],
	});
	...
	//getChoicesMessage › should return a message showing the player and computer choices 
	

	const choicesMessage = getChoicesMessage(playerChoice, computerChoice);
