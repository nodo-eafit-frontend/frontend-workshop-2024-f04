...
export const getChoicesMessage = (playerChoice, computerChoice) => {
    return `Elegiste ${playerChoice.text} ${playerChoice.emoji}, la computadora eligió ${computerChoice.text} ${computerChoice.emoji}.`;
};
...
export const getScoreMessage = (stats) => {
    return `Puntuación: ${stats.score} | Vidas restantes: ${stats.lifes}`;
};